...
export const YEAR_META: Record<string,{year:number, process:string, transistors:string, tdp:string, bw:string, fp8:string, nvlink:string, provenanceStatus:'official'|'official preliminary'|'derived'|'estimated'|'speculative', sourceUrl?: string, asOf?:string, gpcCount?: number, smCount?: number}> = {
  ...
  'b200-sxm': { year:2024, process:'4NP TSMC', transistors:'208B', tdp:'~1000W', bw:'8TB/s', fp8:'1.9 PFLOPS', nvlink:'1.8TB/s (chip)', provenanceStatus:'official', sourceUrl:'https://www.nvidia.com/en-us/data-center/b200/', asOf:'2024-03-18', gpcCount:8, smCount:148 },
  ...
  'rubin-r100': { year:2026, process:'3nm + CoWoS-L', transistors:'336B (official preliminary July 2026 – subject to change)', tdp:'1400W', bw:'22TB/s HBM4 288GB', fp8:'17.5 PFLOPS FP8/FP6 dense, 4 PFLOPS FP16/BF16 (official preliminary)', nvlink:'NVLink 6 3.6TB/s per GPU (7.2TB/s per superchip), C2C 1.8TB/s (official preliminary)', provenanceStatus:'official preliminary', sourceUrl:'https://www.nvidia.com/en-gb/data-center/vera-rubin-nvl72/', asOf:'2026-07-15', gpcCount:8, smCount:224 },

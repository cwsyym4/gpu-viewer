...
const prov: ProvenanceEntry[] = [
  { level:'gpu', field:'hbm.totalGB', value:576, unit:'GB', status:'speculative', sourceUrl:'https://www.nvidia.com/en-us/data-center/rubin/', asOf:'2026-07-15', notes:'Rubin Ultra vision 12×48GB=576GB – speculative concept, not primary sequence. Official product is Vera Rubin NVL72 (R100)' },
  { level:'gpu', field:'memoryBW', value:32, unit:'TB/s', status:'speculative', sourceUrl:'https://www.nvidia.com/en-us/data-center/rubin/', asOf:'2026-07-15', notes:'Speculative envelope, no official NVDA number yet' },
  { level:'gpu', field:'nvlinkDomain', value:1000, unit:'GB/s', status:'speculative', notes:'Vision class, explicitly separate section' },
]
export const rubinUltraSpec: GPUSpec = {
  id:'rubin-ultra-nvl576', label:'Rubin Ultra NVL576 (Speculative Concept)', module:'RUBIN ULTRA NVL576 SPECULATIVE',
...
export const rubinUltraRackSpec: RackSpec = {
  id:'rubin-ultra-nvl576-rack', label:'Rubin Ultra NVL576 Rack (Speculative)', level:'rack', traySpecId:'rubin-r100-compute-tray', trayCount:18, totalGPUs:144, totalCPUs:36, nvlinkDomain_TBs:1000, nvlinkVersion:'NVLink 6 / NVL576 vision 1PB/s – speculative', c2cPerSuperchip_GBs:1800,
  speculative:true,
  provenance:[{ level:'rack', field:'nvlinkDomain', value:1000, unit:'TB/s', status:'speculative', sourceUrl:'https://www.nvidia.com/en-us/data-center/rubin/', asOf:'2026-07-15', notes:'Speculative concept – separate from Vera Rubin NVL72 official'}]
}

...
const prov: ProvenanceEntry[] = [
  { level:'gpu', field:'hbm.totalGB', value:192, unit:'GB', status:'official', sourceUrl:'https://www.nvidia.com/en-us/data-center/b200/', asOf:'2024-03-18', notes:'8x HBM3e 24GB =192GB single B200 GPU' },
...
export const b200Spec: GPUSpec = {
  ...
  gpcCount:8, smPerGpc:24, smCountsPerGpc:[24,24,24,24,24,24,24,24],
  ...
  hbm:{count:8, version:'hbm3e', gbPerStack:24, totalGB:192}, dualDie:true, interposer:true,
  transistorsB:208, smCount:192, tdpW:1000, memoryBW_TBs:8, nvlinkBW_TBs:1.8,

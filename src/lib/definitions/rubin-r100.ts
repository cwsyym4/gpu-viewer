...
const prov: ProvenanceEntry[] = [
  { level:'gpu', field:'transistorsB', value:336, unit:'B', status:'official', sourceUrl:'https://www.nvidia.com/en-us/data-center/rubin/', asOf:'2026-07-15', notes:'Rubin official 336B' },
  { level:'gpu', field:'smCount', value:224, unit:'SMs', status:'official', sourceUrl:'https://www.nvidia.com/en-us/data-center/rubin/', asOf:'2026-07-15' },
  ...
  { level:'gpu', field:'nvlinkBW', value:3.6, unit:'TB/s', status:'official', sourceUrl:'https://www.nvidia.com/en-us/data-center/rubin/', asOf:'2026-07-15' },

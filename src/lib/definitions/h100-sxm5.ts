...
const prov: ProvenanceEntry[] = [
  ...
  { level:'gpu', field:'boardSize', value:'8.6x4.0 render units', unit:'scene-units', status:'illustrative', notes:'Render dims ≠ real mm; real SXM5 ~166×86mm' },
]
export const h100Spec: GPUSpec = {
  ...
  transistorsB:80, smCount:144, tdpW:700, memoryBW_TBs:3.35, nvlinkBW_TBs:0.9,
  provenance:prov,
}

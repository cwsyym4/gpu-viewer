...
function resolveChromePath(): string | undefined {
  ...
  return undefined // let playwright auto-resolve
}
...
export default defineConfig({
  ...
  use: { ...(chromePath ? { launchOptions: launchOpts } : {}), baseURL: process.env.PLAYWRIGHT_BASE_URL ?? 'http://localhost:3000', trace: 'on-first-retry', actionTimeout: 10000 },
